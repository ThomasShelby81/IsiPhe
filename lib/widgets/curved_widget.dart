...
class CurvedWidget extends StatelessWidget{
  ...
  const CurvedWidget({Key? key, this.curvedDistance = 80, this.curvedHeight = 80, required this.child}):super(key: key);
...
class CurvedWidgetBackgroundClipper extends CustomClipper<Path>{
  ...
  const CurvedWidgetBackgroundClipper({required this.curvedHeight, required this.curvedDistance});
